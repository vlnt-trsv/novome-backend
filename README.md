...
- [ ] `GET /schedules/doctor/:id` - Получить расписание врача
- [ ] `GET /schedules/clinics/:id` - Получить расписание клиники
- [x] `POST /schedules/generate/:id` - Генерация слотов на диапазон дат (например, "пн-пт с 9:00 до 18:00 по 30 минут)
