...
- [x] `POST /users/:id` - Добавить/убрать пользователя в/из избранные
...
- [x] `POST /schedules/work-rule` - Создать рабочие правила (Например, обед с 12:00 по 14:00)
- [x] `POST /schedules/break` - Создать перерыв (Например, отпуск с 2026-03-01 по 2026-03-31)
...
- [x] `POST /appointments` - Создать запись на приём к вратчу
